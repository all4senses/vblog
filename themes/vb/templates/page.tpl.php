...
//        if ($user->uid == 1) {
          echo /*'<a id="itexpo" href="http://www.voip-weblog.com/blog/tags/itexpo-2012"></a>',*/ render($page['header']); 
          
          echo vb_blocks_getBlockThemed(array('module' => 'om_maximenu', 'delta' => 'om-maximenu-1', 'no_subject' => TRUE, 'class' => 'block-om-maximenu', 'shadow' => FALSE), TRUE, '+31 day', ($user->uid ? '_logged' : NULL));
