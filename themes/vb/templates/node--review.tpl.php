...
<?php endif; ?>
  ...
  <div class="main-content"  xmlns:v="http://rdf.data-vocabulary.org/#" typeof="v:Review">
        ...
        <div class="content"<?php print $content_attributes; ?>>
          ...
          <div class="vb_votes">
            <?php echo '<div class="caption"><span>' , t('User\'s Rating') , ':</span> <span property="v:rating">' , (empty($node->field_r_rating_overall['und'][0]['value']) ? $node->field_r_rating_overall[0]['value'] : $node->field_r_rating_overall['und'][0]['value']), '</span>' /* render($content['vb_rating_overall'])*/ , '<div class="bottom-clear"></div></div>' , render($content['vb_ratings']); ?>
            <div class="rate-other">
              ...
              <?php endif; ?>
              <div class="text"><?php echo '<div class="title">' . t('Recommend') . ': </div><div class="data">' . $node->vb_recommend . '</div>'?></div>
            </div>
          </div>
