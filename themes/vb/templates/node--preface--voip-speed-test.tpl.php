...
// Ookla speed test page original content. -------------------------------------------------------------------------------
  ...
  $path_to_custom_js = drupal_get_path('module', 'vb_pages') . '/js/';
  drupal_add_js($path_to_custom_js . 'vb_speedtest_page.js');
     ...
     <div class="share">
       <div class="main">
              ...
              <?php
                ...
                $url = 'http://www.voip-weblog.com' . $_SERVER['REQUEST_URI']; 
                echo vb_blocks_getSocialiteButtons($url, $share_title); 
